const UpdateStepOnePrice = ({ stepOneData, register, errors }) => {
  return (
    <section className=" shadow-md bg-gray-50 rounded-lg p-4 sm:p-8 md:p-12">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
        ...
        <div className="">
          ...
          <input
            defaultValue={stepOneData?.product_wholeseller_price}
            {...register("product_wholeseller_price", {
              required: "Product Wholeseller Price is required",
            })}
            id="product_wholeseller_price"
            type="number"
            placeholder="Enter Product Wholeseller Price"
            className="block w-full p-2.5 text-gray-800 outline-primaryColor bg-white border border-gray-300 rounded-lg mt-2"
            min={0}
          />
          {errors.product_wholeseller_price && (
            <p className="text-red-600">
              {errors.product_wholeseller_price?.message}
            </p>
          )}
        </div>
        {/* Product Wholeseller Min Quantity */}
        ...
        <div className="">
          ...
          <input
            defaultValue={stepOneData?.product_wholeseller_min_quantity}
            {...register("product_wholeseller_min_quantity", {
              required: "Product Wholeseller Min Quantity is required",
            })}
            id="product_wholeseller_min_quantity"
            type="number"
            placeholder="Enter Product Wholeseller Min Quantity"
            className="block w-full p-2.5 outline-primaryColor text-gray-800 bg-white border border-gray-300 rounded-lg mt-2"
            min={0}
          />
        ...
        <div className="">
          <label htmlFor="product_reseller_price" className="font-medium">
            Product Reseller Price<span className="text-red-500">*</span>
          </label>
          <input
            defaultValue={stepOneData?.product_reseller_price}
            {...register("product_reseller_price", {
              required: "Product Reseller Price is required",
            })}
            id="product_reseller_price"
            type="number"
            placeholder="Enter Product Reseller Price"
            className="block w-full p-2.5 text-gray-800 outline-primaryColor bg-white border border-gray-300 rounded-lg mt-2"
            min={0}
          />
          {errors.product_reseller_price && (
            <p className="text-red-600">
              {errors.product_reseller_price?.message}
            </p>
          )}
        </div>
...
export default UpdateStepOnePrice;
